...
export function Home() {
  const [sports, setSports] = useState([
    ...
    //   strSportThumbBW:
    //     "https://www.thesportsdb.com/images/sports/bw/soccer.jpg",
    //   strSportIconGreen:
  ...
  const getData = async () => {
    try {
      const data = [];
      await axios
        .get("https://www.thesportsdb.com/api/v1/json/3/all_sports.php")
        .then((response) => {
  ...
  return (
    <div className="container-home">
      <div className="home-card">
        <Suspense>
          <CardComponent sports={sports}></CardComponent>
        </Suspense>
      </div>
    </div>
  );
